...
//            ?>
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                    <form method="post" action="{{route('don-reg')}}" autocomplete="off" role="form" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group">
                            <label class="control-label text-primary" for="mobile">Phone Number</label>
                            <input type="number" placeholder="Phone Number" id="mobile" name="mobile" required class="form-control input-sm">
                        </div>
                        <div class="form-group">
                            <label class="control-label text-primary" for="alternate-mobile">Alternate Mobile Number</label>
                            <input type="number" placeholder="Phone Number" id="alternate-mobile" name="alternate-mobile" required class="form-control input-sm">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <label class="control-label text-primary" for="blood-group" >Blood Group</label>
                            <select id="blood-group" name="blood-group" required class="form-control input-sm">
                        ...
                        <div class="form-group">
                            <label class="control-label text-primary" for="religion" >Religion</label>
                            <select id="religion" name="religion" required class="form-control input-sm">
                                <option value="">Select Religion</option>
                                <option value="A+">Muslim</option>
                                <option value="B+">Hindu</option>
                                <option value="O+">Christian</option>
                                <option value="AB+">Buddhist</option>
                                <option value="A1+">Others</option>
                            </select>
                        </div>
                        <div class="form-group">
                            <label class="control-label text-primary" for="union" >Union</label>
                            <input type="text"  required name="union" id="union" class="form-control" >
                        </div>
                        <div class="form-group">
                            <label class="control-label text-primary" for="post-office" >Post Office</label>
                            <input type="text"  required name="post-office" id="post-office" class="form-control" >
                        </div>
                        <div class="form-group">
                            <label class="control-label text-primary" for="police-station" >Police Station</label>
                            <input type="text"  required name="police-station" id="police-station" class="form-control" >
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <label class="control-label text-primary" for="weight" >Body Weight</label>
                            <input type="text" required placeholder="Weight In Kgs" required name="weight" id="weight" class="form-control" >
                        </div>
                        ...
                        <div class="form-group" id="new">
                                                      <label class="control-label text-primary"  for="NEW_DONOR">New Donor</label>
                                                        <select name="NEW_DONOR"  id="NEW_DONOR" onchange="changeStatus()" class="form-control input-sm">
                                                            <option value="">Select</option>
                                                            <option value="Yes" >Yes</option>
                                                            <option value="No" selected>No</option>
                                                        </select>
                                    </div>
                        <div class="form-group" id="last-donation-box">
                            <label class="control-label text-primary"  for="last-donation">Last Blood Donoted Date</label>
                            <input type="text"  name="last-donation" value="00/00/0000"  id="last-donation" placeholder="YYYY/MM/DD" class="form-control input-sm DATES">
                        </div>
...
<script>
    ...
    function changeStatus() {
        var status =document.getElementById('NEW_DONOR');
            if(status.value =='No')
            {
                document.getElementById("last-donation-box").style.visibility='visible';
            }
            else
            {
                document.getElementById("last-donation-box").style.visibility='hidden';
            }
